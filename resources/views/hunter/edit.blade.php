...
<div class="max-w-md mx-auto mt-10 bg-white p-6 rounded shadow">
    ...
    <h2 class="text-xl font-bold mb-4">Edit Profil Hunter</h2>

    <form action="{{ route('hunter.profil.update') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
