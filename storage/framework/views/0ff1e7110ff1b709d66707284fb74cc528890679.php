...
<body class="bg-gray-100 font-sans">
    ...
    <div class="bg-green-600 text-white sticky top-0 z-50 text-sm flex justify-between px-4 py-2">
        ...
        <div class="flex space-x-4 items-center">
            <form method="POST" action="<?php echo e(route('penitip.logout')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <header class="bg-green-500 text-white sticky top-[32px] z-40 flex items-center justify-between px-6 py-3 shadow">
        <!-- Logo -->
        <a href="<?php echo e(url('/penitip/dashboard')); ?>" class="flex items-center space-x-3">
...
<?php /**PATH C:\Users\abhin\OneDrive\Documents\Tugas\P3L\reusemart\resources\views/layouts/app-penitip.blade.php ENDPATH**/ ?>