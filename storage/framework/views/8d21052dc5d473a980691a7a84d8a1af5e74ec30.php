...
<div id="loginPromptModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white w-96 rounded-lg p-6 shadow-lg text-center">
        ...
        <div class="flex justify-between space-x-2">
            <a href="<?php echo e(route('login.universal.form')); ?>" class="flex-1 bg-green-600 text-white py-2 rounded hover:bg-green-700">Login</a>
...
<body class="bg-gray-100 font-sans">
        ...
        <div class="flex space-x-4 items-center">
            <?php if($pembeli): ?>
                <div class="flex items-center space-x-2">
                    <a href="<?php echo e(route('pembeli.profil')); ?>" class="font-bold flex items-center space-x-2 hover:underline">
                        ...
                        <span><?php echo e($pembeli->username); ?></span>
                    </a>
                </div>
                <form method="POST" action="<?php echo e(route('pembeli.logout')); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="font-bold hover:underline">Logout</button>
                </form>
            <?php else: ?>
                <a href="<?php echo e(route('login.universal.form')); ?>"class="font-bold hover:underline">Login</a>
                <a href="#">|</a>
                <a href="<?php echo e(route('register.all')); ?>"class="font-bold hover:underline">Daftar</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <header class="bg-green-500 text-white sticky top-[32px] z-40 flex items-center justify-between px-6 py-3 shadow">
        ...
        <!-- Search bar -->
        <form id="searchForm" action="<?php echo e(route('search')); ?>" method="GET" class="flex-1 px-12">
...
<?php /**PATH C:\Users\abhin\OneDrive\Documents\Tugas\P3L\reusemart\resources\views/layouts/app.blade.php ENDPATH**/ ?>